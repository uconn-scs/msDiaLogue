...
- center:
  ...
  A logical value (default = TRUE) indicating whether the variables
  should be shifted to be zero centered.

- scale:

  A logical value (default = FALSE) indicating whether the variables
  should be scaled to have unit variance before the analysis takes
  place.
