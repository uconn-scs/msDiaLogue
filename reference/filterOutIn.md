...
- removeList:
  ...
  A logical value (default = TRUE) specifying whether the list of
  proteins should be removed or selected.
...
- saveRm:
  ...
  data to current working directory. This option only works when
  `removeList = TRUE`.
