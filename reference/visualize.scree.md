...
- type:
  ...
  A character vector (default = c("bar", "line")) specifying the plot
  ...
  - c("bar", "line"): Display both bar and line plots.
...
- label:
  ...
  A logical value (default = TRUE) specifying whether labels are added
  at the top of bars or points to show the information retained by each
  dimension.
