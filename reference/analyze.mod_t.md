...
Perform empirical Bayes moderated t-tests (Smyth 2004) on the data.

## Usage

``` r
analyze.mod_t(dataSet, ref = NULL, adjust.method = "none", saveRes = TRUE)
```
...
- adjust.method:
  ...
  A character string (default = "none") specifying the correction method
