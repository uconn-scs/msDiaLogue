...
- thres:
  ...
  A numeric value (default = 1) specifying the vertical dashed line
  drawn at this VIP value.

- rel.widths:

  A numeric value specifying the proportion of relative widths for the
  plot panels. Defaults to widths chosen based on the range of the top
  variables' VIP scores and the number of group conditions.
