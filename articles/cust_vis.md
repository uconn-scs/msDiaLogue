...
For R beginners, **R for Data Science** ([Wickham, Çetinkaya-Rundel, and
Grolemund 2023](#ref-wickham2023r)) is a fantastic resource, available
online at https://r4ds.hadley.nz/. For users particularly interested in
data visualization, **ggplot2: Elegant Graphics for Data Analysis**
([Wickham 2016](#ref-wickham2016ggplot2)), available at
...
![](cust_vis_files/figure-html/unnamed-chunk-2-1.png)
...
for Data Science*. Sebastopol, CA, USA: O’Reilly Media.
