...
#' proteins with NaN should be removed from the data set.
#' 
#' @param filterUnique An integer (default = 2) specifying whether
#' proteins with less than the default number of unique peptides should be
