...
will be removed, as will anything entries with an identifier that contains
the characters "HUMAN". If `removeList = TRUE`, this function will remove
what you've specified and keep the rest.
...
proteins from the data set. The most common instance of this would be proteins
