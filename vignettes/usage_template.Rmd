...
The argumen `adjust.method` is used to specify the testing correction procedure
to be applied to p-values. This adjustment is essential for controlling the
overall error rate when conducting multiple comparisons, as it helps mitigate
the risk of false positives. Several methods are provided:
