...
```{r}
anlys_t <- analyze(dataImput, testType = "t-test", ref = ref)
```
...
```{r}
anlys_mod.t <- analyze(dataImput, testType = "mod.t-test", ref = ref)
```
...
```{r warning=FALSE}
anlys_wilcox <- analyze(dataImput, testType = "wilcox-test", ref = ref)
```
...
```{r}
anlys_MA <- analyze(dataImput, testType = "MA", ref = ref)
```
