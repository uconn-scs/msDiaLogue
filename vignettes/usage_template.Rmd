...
author: 
  - |
    Shiying Xiao$^3$, Charles Watt$^3$, Jennifer C. Liddle$^1$, Jeremy L. Balsbaugh$^1$, and Timothy E. Moore$^2$
  - |
...
experiment will not change across conditions. This assumption is more robust if there are thousands
of species, compared to only hundreds, or tens, so for experiments of very different complexities
