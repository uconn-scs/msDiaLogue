...
The functions in the analyze module calculate the results that can be used
...
```{r}
visualize(anlys_modt$`100pmol-50pmol`, graphType = "test")
```
...
```{r fig.height = 6}
visualize(anlys_modt, graphType = "test")
```
...
```{r}
visualize(anlys_modt$`100pmol-50pmol`, graphType = "volcano",
...
```{r}
visualize(anlys_modt, graphType = "volcano", P.thres = 0.05, F.thres = 1)
```
